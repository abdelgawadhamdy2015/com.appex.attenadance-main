...
class ListShiftItemTablet extends StatefulWidget {
  const ListShiftItemTablet(
      {super.key, required this.shift, required this.enabled});
  final int shift;
  final bool enabled;

  @override
  State<ListShiftItemTablet> createState() => _ListShiftItemTabletState();
}

class _ListShiftItemTabletState extends State<ListShiftItemTablet> {
