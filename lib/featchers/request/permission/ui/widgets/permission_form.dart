                        ...
                        Expanded(
                          child: MyTextForm(
                            ...
                            inputTextStyle: TextStyles.blackRegulerStyle(
                                SizeConfig.fontSize3!),
                            fillColor: ColorManger.lightGray,
                            controller: permissionCubit.totalHoursController,
  ...
  void validateThenAddAttendancePermission(
    ...
    if (permissionCubit.formKey.currentState!.validate()) {
      context.read<PermissionCubit>().emitAddPermissionState(
            PermissionModel(
              day: _selectedDate,
              shift1Start: permissionCubit.attendanceController1.text,
              shift1End: permissionCubit.leaveControoler1.text,
              shift2Start: permissionCubit.attendanceController2.text,
              shift2End: permissionCubit.leaveControoler2.text,
              shift3Start: permissionCubit.attendanceController3.text,
              shift3End: permissionCubit.leaveControoler3.text,
              shift4Start: permissionCubit.attendanceController4.text,
              shift4End: permissionCubit.leaveControoler4.text,
              isMobile: true,
              shift1IsExtended: checkboxState.shifttosecond1,
              shift2IsExtended: checkboxState.shifttosecond2,
              shift3IsExtended: checkboxState.shifttosecond3,
              shift4IsExtended: checkboxState.shifttosecond4,
              note: permissionCubit.noteController.text,
              hasShift2: checkboxState.isChecked2,
              hasShift3: checkboxState.isChecked3,
              hasShift4: checkboxState.isChecked4,
              type: getType(),
