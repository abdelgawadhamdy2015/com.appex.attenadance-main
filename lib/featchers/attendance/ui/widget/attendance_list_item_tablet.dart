...
class AttendanceListItemTablet extends StatefulWidget {
  ...
  const AttendanceListItemTablet({
    super.key,
    this.shift1Complete,
    this.shift2Complete,
    this.shift3Complete,
  ...
  @override
  State<AttendanceListItemTablet> createState() => _AttendanceListItemTabletState();
}

class _AttendanceListItemTabletState extends State<AttendanceListItemTablet> {
