  ...
  Future<ApiResult<AttendanceResponse>> sendAttendanceRecord(
    ...
    try {
      final response = await apiService.sendAttendanceRecord(
          attendanceRequest.x!,
          attendanceRequest.y!,
          attendanceRequest.isAttendFingerprint,
          attendanceRequest.isShift1Complete,
          attendanceRequest.isShift2Complete,
          attendanceRequest.isShift3Complete,
          attendanceRequest.isShift4Complete,
          imageFile: attendanceRequest.imageFile,
          audioFile: attendanceRequest.audioFile);
