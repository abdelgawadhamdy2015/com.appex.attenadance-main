...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$RequestVaccationStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'RequestVaccationState<$T>.loading()';
  }
...
abstract class Loading<T> implements RequestVaccationState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$RequestVaccationStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'RequestVaccationState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements RequestVaccationState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$RequestVaccationStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'RequestVaccationState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements RequestVaccationState<T> {
